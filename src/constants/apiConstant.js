...
export const GET_SCENE_VIEW_BG_INFO_PUBLIC_API = '/configurator/api/v2/scene-view-background-info-public/';
...
export const CONFIG_PUBLIC_DATA = 'configurator/api/config-public-data/';
